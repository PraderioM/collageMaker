...
from input_request_tools import get_dir_path, get_file_path, get_out_path, get_float, get_adjust_method
...
def main():
    ...
    image_path = get_file_path('Insert path to image you want to make a collage of')
